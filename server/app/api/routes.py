...
async def search(request: SearchRequest):
    """Search across legal datasets and provide AI analysis"""
    start_time = time.time()
    
    try:
        # Unified Search (ignores request.dataset as it's all in one Vector DB now)
        ...
        context = ""
        for res in results:
            # res is a SearchResult model, accessing fields normally
        ...
        ai_response = llm_service.chat_completion(history, context=context)
